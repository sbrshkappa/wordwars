...
"[project]/src/shared/dictionaryService.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s({
    "clearDictionaryCache": (()=>clearDictionaryCache),
    "getDictionaryCacheStats": (()=>getDictionaryCacheStats),
    "getWordDefinition": (()=>getWordDefinition),
    "isValidDictionaryWord": (()=>isValidDictionaryWord),
    "isValidDictionaryWordCached": (()=>isValidDictionaryWordCached)
});
...
async function getWordDefinition(word) {
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${DICTIONARY_API_URL}/${word.toLowerCase()}`);
...
async function isValidDictionaryWordCached(word) {
    const now = Date.now();
    ...
    wordCache.set(word.toLowerCase(), {
        isValid,
        timestamp: now
    });
    return isValid;
...
function getDictionaryCacheStats() {
    return {
        size: wordCache.size,
...
//# sourceMappingURL=src_shared_dictionaryService_ts_709deb0d._.js.map